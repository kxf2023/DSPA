...
class AVWGCN(nn.Module):
    ...
    def forward(self, x, node_embeddings, L_tilde_learned):
        ...
        x_gconv = self.dy_gate1(MyActFunc.apply(x_gconv0).transpose(1, 2)) + self.dy_gate2(MyActFunc.apply(x_gconv1).transpose(1, 2))

        #x_gconv = self.dy_gate1(self.act(x_gconv0).transpose(1, 2)) + self.dy_gate2(self.act(x_gconv1).transpose(1, 2))
