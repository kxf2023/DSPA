...
from DSPA import SAG as Network
from BasicTrainer import Trainer
from TrainInits import init_seed
from dataloader import get_dataloader
from TrainInits import print_model_parameters
from utils import get_adjacency_matrix, scaled_Laplacian, cheb_polynomial


#*************************************************************************#
Mode = 'train'
DEBUG = 'False'
DATASET = 'PEMSD8'      #PEMSD3 or PEMSD4 or PEMSD7 or PEMSD8
DEVICE = 'cuda:0'
MODEL = 'DSPA'
...
args.add_argument('--scaling_factor', default=config['model']['scaling_factor'], type=float)
#train
